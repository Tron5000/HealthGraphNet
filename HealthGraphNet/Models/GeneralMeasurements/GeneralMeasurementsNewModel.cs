...
{
    public class GeneralMeasurementsNewModel : GeneralMeasurementsModelBase
    {
        internal const string ContentType = "application/vnd.com.runkeeper.NewGeneralMeasurement+json";
