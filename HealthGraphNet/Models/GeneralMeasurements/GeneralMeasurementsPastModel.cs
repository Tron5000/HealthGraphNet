...
{
    public class GeneralMeasurementsPastModel : GeneralMeasurementsModelBase
    {
        internal const string ContentType = "application/vnd.com.runkeeper.GeneralMeasurement+json";
