...
{
    public class SleepPastModel : SleepModelBase
    {
        internal const string ContentType = "application/vnd.com.runkeeper.Sleep+json";
        ...
        /// <summary>
        /// The URI of the previous sleep measurement in chronological order for the user (omitted for the first sleep measurement). Read only.
        /// </summary>
        [JsonProperty(PropertyName = "previous")]
        public string Previous { get; internal set; }

        /// <summary>
        /// The URI of the next sleep measurement in chronological order for the user (omitted for the most recent sleep measurement). Read only.
        /// </summary>
        ...
        public List<string> nearest_teammate_diabetes { get; internal set; }
    }
}