...
{
    public class DiabetesMeasurementsPastModel : DiabetesMeasurementsModelBase
    {
        internal const string ContentType = "application/vnd.com.runkeeper.DiabetesMeasurement+json";
