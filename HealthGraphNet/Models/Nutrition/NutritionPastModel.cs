...
{
    public class NutritionPastModel : NutritionModelBase
    {
        internal const string ContentType = "application/vnd.com.runkeeper.Nutrition+json";
        ...
        /// <summary>
        /// The URI of the previous nutrition measurement in chronological order for the user (omitted for the first nutrition measurement). Read only.
        /// </summary>
        [JsonProperty(PropertyName = "previous")]
        public string Previous { get; internal set; }

        /// <summary>
        /// The URI of the next nutrition measurement in chronological order for the user (omitted for the most recent nutrition measurement). Read only.
        /// </summary>
