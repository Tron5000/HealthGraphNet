...
{
    public class BackgroundActivitiesPastModel : BackgroundActivitiesModelBase
    {
        internal const string ContentType = "application/vnd.com.runkeeper.BackgroundActivity+json";
        ...
        /// <summary>
        /// The URI of the previous activity for the user (omitted for the oldest activity). Read only.
        /// </summary>
        [JsonProperty(PropertyName = "previous")]
        public string Previous { get; internal set; }

        /// <summary>
        /// The URI of the next activity for the user (omitted for the most-recent activity). Read only.
        /// </summary>
