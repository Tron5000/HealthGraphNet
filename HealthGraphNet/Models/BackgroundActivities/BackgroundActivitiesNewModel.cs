...
{
    public class BackgroundActivitiesNewModel : BackgroundActivitiesModelBase
    {
        internal const string ContentType = "application/vnd.com.runkeeper.NewBackgroundActivity+json";
